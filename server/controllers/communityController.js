...
export async function getCommunityPosts(req, res) {
  try {
    ...
    const posts = await CommunityPost.find(filter)
      ...
      .populate(
        "replies.user",
        "name role businessVerificationStatus avatarKey profileImageUrl town towns userType languages originallyFrom interests businessVibeTags skillLevel socialAccounts lookingFor instagram facebook bio website googleBusinessUrl phone createdAt"
      )
      .sort({ createdAt: -1 });
