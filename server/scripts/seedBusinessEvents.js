...
const businessUsers = [
  ...
  {
    name: "Banff Bites Food Tours",
    email: `foodtours@${SEED_EMAIL_DOMAIN}`,
    avatarKey: null,
    profileImageUrl:
      "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=600&q=80",
    town: "Banff",
    lookingFor: "Guided food tours and local tasting experiences",
    interests: ["Food Tours", "Local Tours", "Restaurant Specials", "Foodie"],
    bio: "Small-group Banff food walks featuring local restaurants, stories, and easy social stops.",
    website: "https://example.com/banff-bites-food-tours",
    instagram: "@banffbites",
    socialAccounts: [
      {
        provider: "instagram",
        handle: "@banffbites",
      ...
      {
        provider: "website",
        url: "https://example.com/banff-bites-food-tours",
        verified: true,
      },
    ],
  },
  {
    name: "Bow Valley Guide Co.",
    email: `guides@${SEED_EMAIL_DOMAIN}`,
    avatarKey: null,
    profileImageUrl:
      "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=600&q=80",
    town: "Canmore",
    lookingFor: "Hiking guides, wildlife walks, and beginner-friendly mountain tours",
    interests: ["Guided Hikes", "Hiking Guides", "Wildlife Tours", "Beginner-friendly"],
    bio: "Local guide-led walks and hikes with an emphasis on pacing, mountain context, and practical safety.",
    website: "https://example.com/bow-valley-guide-co",
    instagram: "@bowvalleyguideco",
  },
  {
    name: "Lake Louise Paddle Tours",
    email: `paddle@${SEED_EMAIL_DOMAIN}`,
    avatarKey: null,
    profileImageUrl:
      "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=600&q=80",
    town: "Lake Louise",
    lookingFor: "Canoe tours and scenic visitor experiences",
    interests: ["Canoe Tours", "Visitor Experiences", "Scenic", "Outdoor"],
    bio: "Scenic paddle experiences for visitors who want an easy guided outing on the water.",
    website: "https://example.com/lake-louise-paddle-tours",
    instagram: "@lakelouisepaddle",
  },
  {
    name: "Rockies Photo Walks",
    email: `photowalks@${SEED_EMAIL_DOMAIN}`,
    avatarKey: null,
    profileImageUrl:
      "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=600&q=80",
    town: "Banff",
    lookingFor: "Photography tours and scenic walking experiences",
    interests: ["Photography Tours", "Photography Walks", "Creative", "Scenic"],
    bio: "Relaxed photo walks for beginners, creators, and visitors who want help finding good light.",
    website: "https://example.com/rockies-photo-walks",
    instagram: "@rockiesphotowalks",
  },
];
...
const eventSeeds = [
  ...
  {
    host: "Banff Bites Food Tours",
    title: "Banff Bites Evening Food Tour",
    category: "Tours & Experiences",
    categories: ["Tours & Experiences", "Food & Drink"],
    categoryTags: ["Food Tours", "Local Tours", "Restaurant Specials"],
    vibeTags: ["Foodie", "Meet new people", "Good for groups", "Registration required"],
    town: "Banff",
    date: dateString(3),
    time: "5:30 PM",
    endTime: "8:00 PM",
    duration: "2.5 hours",
    priceRange: "$95-$125",
    bookingUrl: "https://example.com/banff-bites-food-tours/book",
    locationName: "Banff Avenue Meeting Point",
    address: "138 Banff Avenue, Banff, AB",
    latitude: 51.1767,
    longitude: -115.5704,
    imageUrl:
      "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=1200&q=80",
    description:
      "A small-group walking food tour with local tastings, light Banff history, and enough structure to make it easy to join solo or with friends.",
  },
  {
    host: "Bow Valley Guide Co.",
    title: "Easy Wildlife Walk with a Local Guide",
    category: "Tours & Experiences",
    categories: ["Tours & Experiences", "Outdoors & Sports"],
    categoryTags: ["Wildlife Tours", "Guided Hikes", "Hiking Guides"],
    vibeTags: ["Beginner-friendly", "Relaxed pace", "Scenic", "Outdoor", "No experience needed"],
    town: "Canmore",
    date: dateString(4),
    time: "9:00 AM",
    endTime: "11:30 AM",
    duration: "2.5 hours",
    priceRange: "$65-$85",
    bookingUrl: "https://example.com/bow-valley-guide-co/wildlife-walk",
    locationName: "Canmore Nordic Centre Day Lodge",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&q=80",
    description:
      "A gentle guided walk focused on wildlife awareness, mountain ecology, and safe ways to explore without needing a hard hike.",
  },
  {
    host: "Lake Louise Paddle Tours",
    title: "Lake Louise Canoe Tour",
    category: "Tours & Experiences",
    categories: ["Tours & Experiences", "Outdoors & Sports"],
    categoryTags: ["Canoe Tours", "Visitor Experiences", "Local Tours"],
    vibeTags: ["Scenic", "Outdoor", "Registration required", "Good for groups"],
    town: "Lake Louise",
    date: dateString(6),
    time: "1:00 PM",
    endTime: "3:00 PM",
    duration: "2 hours",
    priceRange: "$110-$150",
    bookingUrl: "https://example.com/lake-louise-paddle-tours/book",
    locationName: "Lake Louise Lakeshore",
    ...
    description:
      "A guided paddle for visitors who want a structured scenic experience with basic instruction and time for photos.",
  },
  {
    host: "Rockies Photo Walks",
    title: "Golden Hour Photography Tour",
    category: "Tours & Experiences",
    categories: ["Tours & Experiences", "Arts & Creativity"],
    categoryTags: ["Photography Tours", "Photography Walks", "Creative Workshops"],
    vibeTags: ["Creative", "Scenic", "Beginner-friendly", "Solo-friendly", "Outdoor"],
    town: "Banff",
    date: dateString(7),
    time: "6:30 PM",
    endTime: "8:30 PM",
    duration: "2 hours",
    priceRange: "$55-$75",
    bookingUrl: "https://instagram.com/rockiesphotowalks",
    ...
    description:
      "A relaxed photo walk for phone or camera users with simple composition tips, scenic stops, and a beginner-friendly pace.",
  },
  {
    host: "Bow Valley Wellness Studio",
    title: "Weekend Yoga Retreat Sampler",
    category: "Tours & Experiences",
    categories: ["Tours & Experiences", "Wellness"],
    categoryTags: ["Yoga Retreats", "Wellness Retreats", "Breathwork"],
    vibeTags: ["Mindful", "Sober-friendly", "Quiet", "Registration required", "Low-impact"],
    town: "Banff",
    date: dateString(9),
    time: "10:00 AM",
    endTime: "2:00 PM",
    duration: "4 hours",
    priceRange: "$80-$120",
    bookingUrl: "https://example.com/bow-valley-wellness/retreat-sampler",
    locationName: "Bow Valley Wellness Studio",
    address: "211 Bear Street, Banff, AB",
    latitude: 51.1771,
    longitude: -115.5722,
    imageUrl:
      "https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&w=1200&q=80",
    description:
      "A half-day retreat-style sampler with gentle yoga, breathwork, tea, and time to reset without a full weekend commitment.",
  },
  {
    host: "Three Sisters Taproom",
